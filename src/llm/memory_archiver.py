...
_EXTRACT_SYSTEM = (
    ...
    "       {subject: 'User', predicate: '觉得好笑', object_text: '同学踩香蕉皮摔跤的事', confidence: 0.4}\n"
    ...
    "- 对话片段首行 [场景: conv_type/conv_id] 提供了当前会话信息，据此填写 recall_scope\n"
    "- 没有值得提取的内容时，返回空数组\n\n"
    '{"memories": [{"subject": "User", "predicate": "...", "object_text": "...", "recall_scope": "global", "confidence": 0.6}, ...]}'
)
