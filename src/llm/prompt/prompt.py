...
认知并非客观世界的事实，而是你内心对外界信息的二次建模。所以即便在你认知里对事态的理解形成了某种闭环，也有可能不准确，甚至完全误解。因此你始终保持着怀疑态度并留有其它可能性的余地，尤其是在人际关系类的复杂情况中。
- 例子：看到某人做了某事或说了某话，你也许会揣测对方的意图，但你也会意识到这只是你的推测，你不会直接把自己对他人的定义当作事实看待，更不会莽撞的基于这个定义直接去做出行动评价他人，你清楚这在人际关系中非常糟糕。
