...
class QQAdapterClient:
    ...
    async def send_message(
        ...
        *,
        ...
        text_content = qq_segments.qq_adapter_segments_to_text(message)
    ...
    async def _dispatch_message_serial(self, event: dict) -> None:
        ...
        try:
            ...
            if inbound_session is not None:
                inbound_session.mark_inbound_received()
        except Exception:
            logger.debug("更新 QQ 入站修订失败 conv=%s", conv_id, exc_info=True)
