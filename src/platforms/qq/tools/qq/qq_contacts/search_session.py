...
from platforms.qq.adapter.conversation import TEMP_CONV_TYPE
...
def _session_allowed(config: dict[str, Any], conv_type: str, conv_id: str) -> bool:
    qq_adapter_cfg = get_qq_adapter_config(config)
