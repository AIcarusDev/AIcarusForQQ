"""Render browser world snapshots into model-facing prompt content."""
...
from llm.compression.config import normalize_world_multimodal_image_limit
...
def render_browser_world_content(
    snapshot: dict | None,
