...
class MaintenanceService:
    ...
    _LONG_TERM_DELETE_ORDER: tuple[str, ...] = (
        ...
        "MemoryV2SummaryInputRelations",
        "MemoryV2SummaryInputEvents",
        "MemoryV2SummaryCache",
        "MemoryV2SummaryInputs",
        "MemoryV2ClusterRevisions",
        "MemoryV2ClusterRelations",
        "MemoryV2ThreadStateRevisions",
        "MemoryV2ThreadStates",
        "MemoryV2MemoryMounts",
        "MemoryV2ClusterMemberRevisions",
        "MemoryV2ClusterMembers",
        "MemoryV2Clusters",
        "MemoryV2ClusterRuns",
        "MemoryV2RelationRevisions",
        "MemoryV2EpisodeMembers",
        "MemoryV2Episodes",
        "MemoryV2EventRelations",
        "MemoryV2EventRelationRuns",
        "MemoryV2EntityMergeSuspicions",
        "MemoryV2EntityMentions",
        "MemoryV2EntityAliases",
        "MemoryV2CanonicalEntities",
        "MemoryV2PreprocessRuns",
        "MemoryV2Relations",
    ...
    def describe_actions(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "summary": "删除旧事件记忆、V2 记忆图谱、向量/检索辅助数据和待归档任务。",
    ...
    async def _delete_long_term_memory_rows(self) -> dict[str, int]:
        ...
        async with aiosqlite.connect(DB_PATH) as db:
            ...
            await self._rebuild_fts(db, "MemoryV2Search")
            await db.commit()
        self._reset_memory_repo_flags()
    ...
    def _reset_memory_repo_flags(self) -> None:
        try:
            import memory.repo.events_v2 as events_v2
